...
import { FaLinkedin, FaInstagram, FaGithub, FaBehance ,FaEnvelope, FaPhone, FaMapMarkerAlt, FaArrowRight } from "react-icons/fa";
    ...
    <footer className="relative bg-gradient-to-b from-gray-900 to-black text-white overflow-hidden">
      ...
      <div className="container mx-auto p-8 relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold mb-4">
                Ready to <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-500">transform</span> your digital presence?
              </h2>
              <p className="text-gray-300 mb-6">
                Let's collaborate and build something extraordinary. Fill out our brief and get started on your journey with Solvitx.
              </p>
              <Link href="/contact" className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-purple-600 to-pink-500 text-white rounded-full font-medium hover:from-purple-700 hover:to-pink-600 transition-all duration-300 shadow-lg group">
                Get in touch
            ...
            <div className="bg-gray-900/50 p-6 rounded-xl backdrop-blur-sm">
              ...
              <p className="text-gray-400 text-sm mb-4">
                Stay updated with the latest in tech, design, and digital marketing.
              </p>
              <div className="flex">
                <input
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 relative z-10 mb-12">
          ...
          <div>
            <div className="mb-6">
              <h3 className="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-pink-500 mb-2">Solvitx</h3>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <a href="mailto:contact@solvitx.com" className="text-gray-300 hover:text-purple-400 transition-colors">contact@solvitx.com</a>
              </div>
              <div className="flex items-center space-x-3">
                <FaPhone className="text-purple-500 flex-shrink-0" />
                <a href="tel:+12345678900" className="text-gray-300 hover:text-purple-400 transition-colors">+1 (234) 567-8900</a>
              </div>
            </div>
            ...
            <div className="flex space-x-4 mt-6">
              ...
              <a href="https://behance.net" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-blue-400 transition-colors">
          ...
          <div>
            ...
            <nav className="grid grid-cols-1 gap-3">
              <Link href="/services" className="text-gray-300 hover:text-white hover:translate-x-2 transition-all duration-300 flex items-center">
          ...
          <div>
            ...
            <nav className="grid grid-cols-1 gap-3">
              <Link href="/" className="text-gray-300 hover:text-white hover:translate-x-2 transition-all duration-300 flex items-center">
                Home
              </Link>
              <Link href="/about" className="text-gray-300 hover:text-white hover:translate-x-2 transition-all duration-300 flex items-center">
                About Us
              </Link>
              <Link href="/services" className="text-gray-300 hover:text-white hover:translate-x-2 transition-all duration-300 flex items-center">
                Our Services
              </Link>
              <Link href="/contact" className="text-gray-300 hover:text-white hover:translate-x-2 transition-all duration-300 flex items-center">
                Contact Us
              </Link>
              <Link href="/blog" className="text-gray-300 hover:text-white hover:translate-x-2 transition-all duration-300 flex items-center">
                Blog
              </Link>
            </nav>
          </div>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h4 className="text-white font-medium">Yash Soni</h4>
              ...
              <Link href="/about" className="inline-flex items-center text-purple-400 hover:text-purple-300 transition-colors mt-2">
        ...
        <div className="pt-8 border-t border-gray-800">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-500 text-sm mb-4 md:mb-0">
              © {currentYear} Solvitx. All rights reserved. Powered by <a href="https://techieyash.com/" target="_blank" rel="noopener noreferrer" className="text-purple-400 hover:text-purple-300">TechieYash</a>
            </p>
