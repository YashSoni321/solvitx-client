    ...
    <section className="py-4 md:py-4 bg-white">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl font-bold text-gray-900 mb-4">
            Apps That Generated <span className="text-green-600">$10M+ Revenue</span>
          </h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Real results from real businesses - see how our apps transformed their growth
          </p>
        </div>
          ...
          {[
            {
              ...
              testimonial: `Our e-commerce app generated $2.3M in first year. SolvitX delivered in 28 days with zero bugs. The ROI was incredible - 400% increase in mobile sales within 6 months.`,
              avatarInitial: "S",
              color: "bg-blue-500",
              metric: "$2.3M Revenue",
            },
            {
              ...
              testimonial:
                "50,000+ active users in 8 months. The app SolvitX built handles our complex healthcare workflows perfectly. We've saved $500K annually on operational costs.",
              avatarInitial: "M",
              color: "bg-purple-500",
              metric: "50K+ Users",
            },
            {
              name: "Emily Rodriguez",
              company: "Director, GrowthCorp",
              testimonial:
                "250% increase in customer engagement. The app's performance is flawless across all devices. SolvitX's support team responds within 2 hours, always.",
              avatarInitial: "E",
              color: "bg-pink-500",
              metric: "250% Growth",
            },
            ...
            <div
              key={index}
              className="bg-white p-4 md:p-8 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 relative border border-gray-100"
            >
              ...
              <p className="text-gray-700 mb-6 text-sm md:text-base lg:text-lg leading-relaxed pt-8 font-medium">
                "{client.testimonial}"
              </p>
