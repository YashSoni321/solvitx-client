    ...
    <div className="min-h-screen bg-gray-50 text-gray-800">
      ...
      <div id="home">
        <HeroSection
          ...
          heading="Turn Your App Idea Into "
          highlight="A Market-Ready Reality"
          subheading="Transform your vision into a powerful mobile app. Our expert team builds custom iOS & Android applications that users love and businesses rely on. Start your app journey today!"
      ...
      <section id="about" className="py-4 md:py-4 bg-gray-900 text-white">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-16 items-center">
            <div>
              <SectionHeading
                title="Your Trusted Partner in Mobile App Development"
                subtitle="Why Choose Us"
                description="From startups to enterprises, we build powerful mobile applications that engage users and drive business growth. Our expert team delivers native and cross-platform solutions that stand out in the app stores."
                theme="light"
                ...
                {[
                  {
                    ...
                    label:
                      "Native iOS & Android Apps with Latest Technologies (Swift, Kotlin)",
                  },
                  {
                    icon: <FaRocket className="text-blue-400" />,
                    label:
                      "Fast Development & Launch (8-12 Weeks Average Timeline)",
                  },
                  {
                    icon: <FaShieldAlt className="text-blue-400" />,
                    label:
                      "Secure Data Handling & Robust Backend Infrastructure",
                  },
                  {
                    icon: <FaChartLine className="text-blue-400" />,
                    label: "App Store Optimization & Marketing Support",
                  },
                ].map((item) => (
                  <div
                    key={item.label}
      ...
      <section className="py-4 md:py-4 bg-gray-900 text-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8">
            {[
              { value: 100, label: "Apps Published", suffix: "+" },
              { value: 4.8, label: "App Store Rating", suffix: "★" },
              { value: 1, label: "Million+ Downloads", suffix: "M" },
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-lg md:text-xl text-white/90 mb-8">
              Special Launch Offer: Get a FREE UI/UX Prototype + App Store
              Optimization Package (Worth $4,999)
            </p>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
              <div className="bg-white/10 p-6 rounded-xl backdrop-blur-sm">
                ...
                <p className="text-white/80">
                  iOS & Android apps with platform-specific features
                </p>
              </div>
              <div className="bg-white/10 p-6 rounded-xl backdrop-blur-sm">
                <div className="text-3xl mb-3">⚡</div>
                ...
                <p className="text-white/80">
                  90-day development to app store launch
                </p>
              </div>
              <div className="bg-white/10 p-6 rounded-xl backdrop-blur-sm">
                <div className="text-3xl mb-3">🎯</div>
