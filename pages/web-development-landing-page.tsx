  ...
  const faqs = [
    {
      ...
      answer:
        "We specialize in developing various types of websites including: E-commerce platforms, Corporate websites, Landing pages, Web applications, Custom CMS solutions, Blogs & content platforms, and Progressive Web Apps (PWAs). All our websites are responsive, SEO-optimized, and built with the latest technologies.",
    },
    {
      question: "How much does a website cost and what's included?",
      answer:
        "Website costs vary based on your specific needs. Our basic business websites start from $2,999 and include: Custom design, Mobile responsiveness, Basic SEO setup, Contact forms, 5 core pages, and 3 months of support. E-commerce and custom web applications are quoted based on features required. Contact us for a detailed quote.",
    },
    {
      question: "What's your web development process?",
      answer:
        "Our process includes: 1) Discovery & Requirements gathering, 2) Design mockups & wireframes, 3) Development using modern tech stack, 4) Testing & QA, 5) Deployment & Launch, 6) Post-launch support. We keep you involved at every stage with regular updates and feedback sessions.",
    },
    {
      question: "Do you provide website maintenance and hosting?",
      answer:
        "Yes, we offer comprehensive maintenance packages that include: Regular updates, Security monitoring, Performance optimization, Content updates, 24/7 support, and Reliable hosting on premium servers. Our hosting includes SSL certificates, daily backups, and CDN integration.",
    },
    {
      question: "How long does it take to build a website?",
      answer:
        "Timeline varies by project complexity: Simple business websites: 2-4 weeks, E-commerce websites: 6-8 weeks, Custom web applications: 8-12 weeks. We provide a detailed timeline during the project scoping phase and keep you updated on progress throughout development.",
    },
  ];
    ...
    <div className="min-h-screen bg-gray-50 text-gray-800">
      ...
      <div id="home">
        <HeroSection
          ...
          subheading="Get a high-performance, SEO-optimized website that converts visitors into customers. Our expert team delivers custom web solutions that help your business stand out and grow online."
      ...
      <section id="about" className="py-4 md:py-4 bg-gray-900 text-white">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-16 items-center">
            <div>
              <SectionHeading
                title="Expert Web Development Services Tailored for Your Success"
                subtitle="Why Choose Us"
                description="We specialize in creating modern, high-performance websites that drive real business results. Our team combines technical expertise with business understanding to deliver solutions that work."
                theme="light"
                ...
                {[
                  {
                    ...
                    label:
                      "Custom Web Development using Latest Technologies (React, Next.js, Node.js)",
                  },
                  {
                    icon: <FaChartLine className="text-blue-400" />,
                    label:
                      "Performance Optimization & Fast Loading Speeds (90+ PageSpeed Score)",
                  },
                  {
                  ...
                  },
                  {
                    ...
                    label: "Built-in SEO & Mobile-First Development",
                  },
                ].map((item) => (
                  <div
                    key={item.label}
            ...
            <div className="bg-gradient-to-br border-amber-50 border-4 p-4 md:p-8 lg:p-10 rounded-2xl shadow-2xl">
              <h3 className="text-xl md:text-2xl lg:text-3xl font-bold mb-6 text-center text-white">
                Get Your Free Website Audit & Consultation
              </h3>
              <p className="text-gray-300 text-sm md:text-base text-center mb-8">
                🚀 24-Hour Turnaround | 💡 Actionable Insights | 📊 Competitive
                Analysis
              </p>
              {submitSuccess && (
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8">
            {[
              ...
              { value: 250, label: "Websites Delivered", suffix: "+" },
              { value: 15, label: "Avg. Conversion Rate", suffix: "%" },
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-4xl mx-auto">
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-white mb-4">
              Limited Time Offer: Get Your Website Audit + SEO Report
            </h2>
            <p className="text-lg md:text-xl text-white/90 mb-8">
              Worth $499 - Now FREE for Limited Time! Includes performance
              analysis, SEO audit, and actionable recommendations.
            </p>
            <button
              onClick={() =>
                document
