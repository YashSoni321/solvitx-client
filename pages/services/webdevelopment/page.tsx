...
import { FaLightbulb, FaCode, FaMobile, FaDatabase, FaSearch, FaDesktop } from 'react-icons/fa';
...
const services = [
  {
    ...
    description: "We develop comprehensive digital strategies that align with your business goals and help you achieve sustainable growth.",
    color: "from-yellow-400 to-orange-500",
  },
  {
    icon: <FaCode className="text-5xl text-blue-400" />,
    title: "Web Development",
    description: "Custom, responsive, and scalable web applications built with modern technologies that deliver exceptional user experiences.",
  ...
  },
  {
    ...
    description: "Scalable, secure cloud infrastructure and migration services to optimize your operations and reduce costs.",
    color: "from-purple-400 to-violet-600",
  },
  {
    icon: <FaSearch className="text-5xl text-red-400" />,
    title: "SEO & Marketing",
    description: "Data-driven digital marketing strategies that increase your visibility, drive traffic, and convert visitors into customers.",
    ...
    <>
      ...
      <div className="relative h-screen w-full overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full text-white px-6 text-center">
          ...
          >
            Comprehensive technology solutions crafted with expertise and innovation to drive your business forward
          </motion.p>
          ...
          >
            ...
            <div className="max-w-2xl">
              <p className="text-xl lg:text-2xl text-gray-200 mb-6">
                We provide end-to-end technology solutions tailored to your specific needs, helping you navigate the digital landscape with confidence.
              </p>
              <p className="text-gray-400">
                Each service is delivered with a commitment to quality, innovation, and measurable results that propel your business forward.
              </p>
            </div>
          </motion.div>
        </div>
        ...
        >
          {services.map((service, index) => (
            ...
            >
              ...
              <p className="relative text-gray-300 mb-6">{service.description}</p>
      ...
      <div className="bg-gradient-to-t from-gray-900 to-black py-20 px-4">
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            Let's discuss how our services can be tailored to meet your specific business needs and objectives.
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
