...
import { FaLinkedin, FaInstagram, FaEnvelope, FaMapMarkerAlt, FaChevronRight } from 'react-icons/fa';
...
const workStages = [
  {
    ...
    description: "We analyze your business, market and goals to craft a custom digital strategy."
  },
  {
    title: "Design",
    icon: <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12a2 2 0 002-2v-4a2 2 0 00-2-2h-2.343M11 7.343l1.657-1.657a2 2 0 012.828 0l2.829 2.829a2 2 0 010 2.828l-8.486 8.485M7 17h.01" /></svg>,
    color: "from-purple-500 to-pink-400",
    description: "Visually appealing and user-centric designs that turn visitors into customers."
  },
  {
    title: "Development",
    icon: <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 9l3 3-3 3m5 0h3M5 20h14a2 2 0 002-2V6a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" /></svg>,
    color: "from-orange-500 to-amber-400",
    description: "Robust and scalable code to bring your ideas to life across all platforms."
  },
  {
    title: "Launch",
    icon: <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z" /></svg>,
    color: "from-green-500 to-emerald-400",
    description: "Deploy, test, and launch your project with precision and confidence."
  }
];
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:title" content="Contact Us — Solvitx | Let&apos;s Build Something Amazing" />
        <meta property="og:description" content="Reach out to Solvitx and let's discuss how we can help bring your vision to life with cutting-edge technology solutions." />
      ...
      <div className="relative h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-black flex items-center justify-center">
        <div className="text-center px-4">
          <div className="inline-block mb-6">
            <div className="w-28 h-28 rounded-full bg-gradient-to-r from-pink-500 to-purple-600 flex items-center justify-center p-1 mx-auto relative overflow-hidden">
              <div className="w-full h-full rounded-full bg-black flex items-center justify-center">
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-500 to-purple-600 text-4xl font-extrabold">S</span>
              </div>
          ...
          <h1 className="text-5xl md:text-7xl font-extrabold text-white leading-tight max-w-5xl mx-auto">
            Let&apos;s Transform Your <span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500">Ideas</span> Into Reality
          </h1>

          <p className="mt-6 text-xl md:text-2xl text-gray-300 max-w-3xl mx-auto">
            Reach out to us and discover how our expertise can help bring your vision to life
          </p>
        </div>
      </div>
        ...
        <div className="container mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Have a project in mind? Fill out the form below and let&apos;s start a conversation about your needs.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div className="bg-gradient-to-br from-gray-900 to-gray-800 rounded-2xl p-8 shadow-xl">
              <form onSubmit={handleSubmit}>
                ...
                <div className="mb-6">
                  <label className="block text-gray-300 mb-2" htmlFor="budget">Project Budget</label>
                  <select
                    id="budget"
                    name="budget"
                ...
                <div>
                  <button
                    type="submit"
                    className="w-full bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white font-bold py-4 px-8 rounded-lg shadow-lg hover:shadow-xl"
                  >
                    Send Message
                  </button>
                </div>
            ...
            <div>
              ...
              <div className="mb-16 relative">
                ...
                <h3 className="text-3xl font-bold text-white mb-6">About Solvitx</h3>
                
                <div className="text-gray-300 space-y-6">
                  <p>
                    We&apos;re not just another tech company. At Solvitx, we combine creativity, technical expertise, and business acumen to create digital solutions that make a real difference.
                  </p>
                  ...
                  <p>
                    Since our founding, we have helped businesses of all sizes transform their digital presence and build products that their users love.
                  </p>
                </div>
              </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400">123 Tech Avenue, Innovation District<br />San Francisco, CA 94103</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400">contact@solvitx.com<br />support@solvitx.com</p>
                    </div>
                  </div>
                </div>
              </div>
