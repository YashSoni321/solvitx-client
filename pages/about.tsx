...
import { FaLightbulb, FaHandshake, FaRocket, FaChevronRight, FaQuoteLeft } from 'react-icons/fa';
...
const founders = [
  {
    ...
    quote: "Technology should solve real problems, not create new ones. Our mission is to deliver solutions that make a tangible difference."
  },
  {
    name: "Yash Soni",
    role: "Co-Founder & CTO",
    ...
    quote: "We build with tomorrow in mind - creating solutions that don't just work today, but evolve with your business."
  }
];
...
const processSteps = [
  {
    number: "01",
    title: "Discovery",
    description: "We dive deep into understanding your business, goals, and challenges through collaborative workshops and research.",
    icon: <FaLightbulb className="text-3xl text-purple-400" />
  },
  {
    number: "02",
    title: "Strategy",
    description: "Based on insights gained, we craft a tailored digital strategy that aligns with your objectives and market position.",
    icon: <FaHandshake className="text-3xl text-blue-400" />
  },
  {
    number: "03",
    title: "Execution",
    description: "Our expert team brings the vision to life with cutting-edge technology, regular updates, and transparent communication.",
    icon: <FaRocket className="text-3xl text-pink-400" />
  },
  {
    number: "04",
    title: "Growth",
    description: "Launch is just the beginning. We provide ongoing support, optimization, and strategic guidance for sustainable growth.",
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:title" content="About Us — Solvitx | Where Vision Meets Technology" />
        <meta property="og:description" content="Meet the team behind Solvitx and learn about our journey to create digital experiences that drive real business results." />
        ...
        <div className="relative z-10 container mx-auto px-4 py-20 text-center">
          ...
          >
            <h1 className="text-5xl md:text-7xl font-extrabold text-white leading-tight mb-6">
              We Do not Just Build <span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500">Solutions</span>
              <br />We Build <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500">Relationships</span>
            </h1>
            
            <p className="mt-6 text-xl md:text-2xl text-gray-300 max-w-3xl mx-auto">
              Since 2018, we have been transforming businesses through technology that matters.
            </p>
          </motion.div>
          ...
          >
            <motion.div variants={fadeIn}>
              ...
              <div className="text-gray-300 space-y-6 text-lg">
                <p>
                  <span className="text-pink-500 font-bold">Solvitx</span> was born from a simple yet powerful idea: technology should solve real problems, not create new ones.
                </p>
                <p>
                  In a digital landscape cluttered with complexity, we set out to build a company that combines technical excellence with genuine understanding of business needs.
                </p>
                <p>
                  Founded by Yash Soni and Pratham in 2018, we have grown from a two-person operation working out of a small apartment to a full-service digital agency trusted by businesses worldwide.
                </p>
                <p>
                  What sets us apart isn't just what we build—it is how we build it. Every project begins with deep listening, followed by strategic thinking, and only then do we craft solutions that truly matter.
                </p>
              </div>
            </motion.div>
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          >
            ...
            <p className="text-xl text-gray-300">
              We envision a world where technology empowers rather than complicates—where digital solutions create meaningful connections instead of barriers.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              <div className="w-16 h-16 mx-auto bg-purple-900/30 rounded-full flex items-center justify-center mb-6">
                <span className="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-400">01</span>
              </div>
              <h3 className="text-xl font-bold text-white mb-4">Excellence in Execution</h3>
              <p className="text-gray-300">
                We believe that exceptional results come from uncompromising standards. Every line of code, every pixel, every user interaction is crafted with precision.
              </p>
            </motion.div>
            ...
            >
              <div className="w-16 h-16 mx-auto bg-pink-900/30 rounded-full flex items-center justify-center mb-6">
                <span className="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-pink-400 to-purple-400">02</span>
              </div>
              <h3 className="text-xl font-bold text-white mb-4">People-First Technology</h3>
              <p className="text-gray-300">
                Technology exists to serve people, not the other way around. We create solutions that adapt to human needs, behaviors, and expectations.
              </p>
            </motion.div>
            ...
            >
              <div className="w-16 h-16 mx-auto bg-indigo-900/30 rounded-full flex items-center justify-center mb-6">
                <span className="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-blue-400">03</span>
              </div>
              <h3 className="text-xl font-bold text-white mb-4">Continuous Innovation</h3>
              <p className="text-gray-300">
                The digital landscape never stands still, and neither do we. We constantly explore new technologies and methodologies to keep our clients ahead.
              </p>
            </motion.div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Visionaries who turned a passion for technology into a mission to transform businesses.
            </p>
          </motion.div>
      ...
      <section className="py-24 bg-black">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <div className="w-20 h-2 bg-gradient-to-r from-purple-500 to-pink-500 mb-8 mx-auto"></div>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Our proven process ensures that every project delivers exceptional results.
            </p>
          </motion.div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-6">
                    <div className="flex items-center mb-2">
                      <span className="text-lg font-bold text-purple-400 mr-2">{step.number}</span>
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-10">
              Let's build something amazing together. Reach out to discuss how we can help you achieve your digital goals.
            </p>
            <a
              href="/contact"
